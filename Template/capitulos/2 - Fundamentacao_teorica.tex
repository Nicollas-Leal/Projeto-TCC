...
\begin{itemize}
    \item Simplicidade e clareza: reduzir elementos visuais desnecessários e adotar linguagem direta.
    \item Consistência e previsibilidade: padrões de navegação estáveis favorecem o aprendizado.
    \item Feedback imediato: confirmações claras reduzem incertezas e ansiedade.
    \item Tamanhos e espaciamentos adequados: tornam a interação menos sujeita a erros.
    \item Progressive disclosure: evita sobrecarga cognitiva.
    \item Multimodalidade: uso combinado de texto, ícones e imagens favorece a compreensão.
    \item Tolerância a erros: caminhos de correção devem ser facilmente compreensíveis.
\end{itemize}
